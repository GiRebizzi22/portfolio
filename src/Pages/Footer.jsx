      ...
      <div className='footer--link--container'>
        ...
        <div className='footer--social--icon'>
          <ul>
            <li>
              <a
                href='https://github.com/GiRebizzi22/portfolio'
                className='navbar--content'
                target='_blank'
                rel='noreferrer'
              >
                <img src='./img/github1.png' alt='Logo Github' />
                <path
            ...
            <li>
              <a
                ...
                rel='noreferrer'
              >
                <img src='./img/instagram1.png' alt='instagram logo' />
            ...
            <li>
              <a
                href='https://www.linkedin.com/in/giovanna-rebizzi-356b52267/'
                className='navbar--content'
                target='_blank'
                rel='noreferrer'
              >
                <img src='./img/linkedin2.png' alt='Linkedin Logo' />
                <path
                  fillRule='evenodd'
                  clipRule='evenodd'
